            ...
            {f.links?.map((link, i) =>
              link ? (
                <Link
                  key={link.id}
                  to={link.url ?? ""}
                  className={"link link-hover" + (i % 4 === 0 ? " pt-3" : "")}
                >
                  {link.title}
                </Link>
              ) : null
          ...
          <div className="flex gap-4">
            ...
            >
              ...
              >
                ...
                />
                <path
                  d="M17.1569 8.09509C17.8401 8.09509 18.3939 7.54127 18.3939 6.85809C18.3939 6.17492 17.8401 5.62109 17.1569 5.62109C16.4737 5.62109 15.9199 6.17492 15.9199 6.85809C15.9199 7.54127 16.4737 8.09509 17.1569 8.09509Z"
                  fill="currentColor"
                />
              </svg>
            </a>
